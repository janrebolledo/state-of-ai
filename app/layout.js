...
export default function RootLayout({ children }) {
  return (
    <html lang='en'>
      ...
      >
        {children}
        <div className='fixed top-0 left-0 right-0 bottom-0 grid grid-cols-2 pointer-events-none overflow-hidden z-20  mix-blend-color-burn backdrop-saturate-[110%] backdrop-blur-[0.5px]'>
